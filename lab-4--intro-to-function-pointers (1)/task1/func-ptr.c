...
int my_comparer(const void *this, const void *that)
{
  ...
  Process *process1;
  Process *process2;
  int process1_arr_time;
  int process2_arr_time;
  int process1_p;
  int process2_p;
  
  process1 = (Process*) this;
  process2 = (Process*) that;
  
  process1_p = process1->priority;
  process2_p = process2->priority;
  
  if (process1_p == process2_p) {
    return (process1_arr_time - process2_arr_time);
    
  }
  return (process2_p - process1_p);
	//return 0;
